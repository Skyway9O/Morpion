...
path = path.dirname(__file__) + "/images/"

image_croix = PhotoImage(file="{}croix_morpion.png".format(path))
image_rond = PhotoImage(file="{}rond_morpion.png".format(path))
image_rien = PhotoImage(file="{}image_vide.png".format(path))
